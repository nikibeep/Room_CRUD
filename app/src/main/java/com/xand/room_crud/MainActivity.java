...
public class MainActivity extends AppCompatActivity {
    ...
    private void showNotification(int numberOfNewRecords) {
        // Define a notification channel for devices running Android Oreo and above.
        ...
        Notification notification = new Notification.Builder(this, "my_channel_id")
                .setContentTitle("New Records Saved")
                .setContentText("Number of new records: " + numberOfNewRecords)
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == ADD_COURSE_REQUEST && resultCode == RESULT_OK) {
            ...
            // Increment the new records count and show the updated notification.
            newRecordsCount++;
            showNotification(newRecordsCount);
